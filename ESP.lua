            ...
            if rootPart and head and humanoid and shouldShow then
                ...
                if onScreen then
                    ...
                    if ESP_SETTINGS.ShowHealthText and ESP_SETTINGS.Enabled then
                        ...
                        esp.healthText.Text = string.format("%d%%", math.floor(healthPercent * 100))
                        esp.healthText.Position = Vector2.new(boxPosition.X + 5, boxPosition.Y + 5)
                        esp.healthText.Color = Color3.new(1, 0, 0):Lerp(Color3.new(0, 1, 0), healthPercent)
