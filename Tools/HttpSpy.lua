...
local serialize = loadstring(game:HttpGet("https://raw.githubusercontent.com/XingFork/Script/refs/heads/main/Tools/Serializer.lua"))()
...
local HttpMethod = newcclosure(function(self, method, ...)
...
oldnamecall = hookmetamethod(game, "__namecall", newcclosure(function(self, ...)
    ...
    if checkcaller() then
        ...
        elseif self == HttpService and tologs.Request and (method == "RequestInternal" or method == "RequestAsync") then
            return HttpMethod(self, method, ...)
        end
    end
...
oldindex = hookmetamethod(game, "__index", newcclosure(function(self, key)
    if checkcaller() then
        ...
        elseif self == HttpService and tologs.Request and (key == "RequestInternal" or key == "RequestAsync") then
            return newcclosure(function(self, ...)
                return HttpMethod(self, key, ...)
            end)
        end
